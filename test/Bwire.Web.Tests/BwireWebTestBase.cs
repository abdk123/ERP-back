...
{
    public abstract class BwireWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static BwireWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(BwireWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<BwireDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<BwireDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<BwireDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<BwireDbContext, Task<T>> func)
        {
            T result;
